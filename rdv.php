...
<?php
        ...
        if (isset($_POST['nom'])&& isset($_POST['prenom']) && isset($_POST['email'])&& isset($_POST['numero']) && isset($_POST['date'])) {
            ...
            try {
                ...
                $req3 = $bdd->prepare("INSERT INTO clients SET nom_client = :nom, prenom_client = :prenom, email_client = :email, id_rdv=:idRdv ");
                $resultat1 = $req3->execute(array(':nom' => $name, ':prenom' => $prenom, ':email' =>$email, 'idRdv' => $last_id));
